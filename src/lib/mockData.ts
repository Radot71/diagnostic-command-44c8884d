...
export const demoScenarios: { name: string; data: WizardData }[] = [
  {
    ...
    data: {
      ...
      dealEconomics: { ...DEFAULT_DEAL_ECONOMICS, dealType: 'turnaround', enterpriseValue: '120', equityCheck: '35', entryEbitda: '12', ebitdaMargin: '14', usRevenuePct: '92', exportExposurePct: '5', macroSensitivities: ['rising-rates', 'commodity-volatility'], timeHorizonMonths: 36 },
  ...
  },
  {
    ...
    data: {
      ...
      dealEconomics: { ...DEFAULT_DEAL_ECONOMICS, dealType: 'platform-buyout', enterpriseValue: '210', equityCheck: '100', entryEbitda: '8', ebitdaMargin: '19', usRevenuePct: '70', exportExposurePct: '0', macroSensitivities: ['weaker-usd', 'rising-rates'], timeHorizonMonths: 48 },
      operatingMetrics: { ...DEFAULT_OPERATING_METRICS },
    },
  },
  {
    ...
    data: {
      ...
      dealEconomics: { ...DEFAULT_DEAL_ECONOMICS, dealType: 'recapitalization', enterpriseValue: '180', equityCheck: '40', entryEbitda: '15', ebitdaMargin: '12', usRevenuePct: '100', exportExposurePct: '0', macroSensitivities: ['rising-rates', 'pmi-contraction', 'supply-chain-risk'], timeHorizonMonths: 18 },
      operatingMetrics: { ...DEFAULT_OPERATING_METRICS },
    },
  },
  {
    ...
    data: {
      ...
      dealEconomics: { ...DEFAULT_DEAL_ECONOMICS, dealType: 'recapitalization', enterpriseValue: '150', equityCheck: '30', entryEbitda: '14', ebitdaMargin: '13', usRevenuePct: '95', exportExposurePct: '8', macroSensitivities: ['rising-rates', 'commodity-volatility', 'pmi-contraction'], timeHorizonMonths: 24 },
      operatingMetrics: { ...DEFAULT_OPERATING_METRICS },
    },
  },
  {
    ...
    data: {
      ...
      dealEconomics: { ...DEFAULT_DEAL_ECONOMICS, dealType: 'add-on', enterpriseValue: '130', equityCheck: '55', entryEbitda: '13', ebitdaMargin: '14', usRevenuePct: '85', exportExposurePct: '10', macroSensitivities: ['weaker-usd', 'supply-chain-risk'], timeHorizonMonths: 36 },
      operatingMetrics: { ...DEFAULT_OPERATING_METRICS },
    },
  },
  {
    ...
    data: {
      ...
      dealEconomics: { ...DEFAULT_DEAL_ECONOMICS, dealType: 'growth-investment', enterpriseValue: '275', equityCheck: '150', entryEbitda: '5', ebitdaMargin: '9', usRevenuePct: '65', exportExposurePct: '0', macroSensitivities: ['falling-rates', 'pmi-expansion'], timeHorizonMonths: 24 },
      operatingMetrics: { ...DEFAULT_OPERATING_METRICS },
    },
  },
];
